...
<div id="page">
  <header id="masthead" class="site-header container" role="banner">
    <div class="bgwrapper">
      <img src="<?php print base_path() . drupal_get_path('theme', 'nexusv2') . '/images/bg.jpeg'; ?>"/>
      <div class="row">
    ...
    </div> <!--class bgwrapper customized to give background -->
  </header>

<!-- cut flexslider container. go to proj log feb20 for the lines xd-->
