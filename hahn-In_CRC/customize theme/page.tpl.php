...
<div id="page">
  ...
  <?php if ($is_front): ?>
  <?php if (theme_get_setting('slideshow_display','nexusv2')): ?>
  <?php
    $slide1_head = check_plain(theme_get_setting('slide1_head','nexusv2'));   $slide1_desc = check_markup(theme_get_setting('slide1_desc','nexusv2'), 'full_html'); $slide1_url = check_plain(theme_get_setting('slide1_url','nexusv2'));
    $slide2_head = check_plain(theme_get_setting('slide2_head','nexusv2'));   $slide2_desc = check_markup(theme_get_setting('slide2_desc','nexusv2'), 'full_html'); $slide2_url = check_plain(theme_get_setting('slide2_url','nexusv2'));
    $slide3_head = check_plain(theme_get_setting('slide3_head','nexusv2'));   $slide3_desc = check_markup(theme_get_setting('slide3_desc','nexusv2'), 'full_html'); $slide3_url = check_plain(theme_get_setting('slide3_url','nexusv2'));
  ?>
  <div id="slidebox" class="flexslider">
    <ul class="slides">
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexusv2') . '/images/slide-image-1.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexusv2') . '/images/slide-image-2.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexusv2') . '/images/slide-image-3.jpg'; ?>"/>
